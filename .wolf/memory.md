...
| 11:16 | Fixed Vercel build failure: QuickAddSupplierModal onCreated merged a QuickSupplier (missing opening_balance) into typed Supplier[] state; installed node_modules and ran real tsc/next build to verify (compiled clean; unrelated supabaseUrl env error during static page-data collection is a local-env limitation, not a code bug) | components/supplier-tracking/SupplierTrackingClient.tsx, .wolf/buglog.json | fixed, tsc clean | ~2.5k |
