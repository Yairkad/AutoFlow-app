  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={{ fontSize: '11px', color: 'var(--text-muted)', lineHeight: 1.6 }}>
        "בפועל" = תנועות כסף שכבר נרשמו. "הכנסה מוכרת" = סכום חשבוניות שהופקו ללקוחות כרטסת באותו חודש, בלי קשר לגבייה בפועל. "חובות פתוחים" = הסכום מאותו חודש שעדיין לא שולם/נגבה נכון להיום. "רווח מתואם" = רווח בפועל + הכנסה מוכרת + חובות פתוחים ללקוחות − חובות פתוחים לספקים − צ'קים/העברות שטרם נפרעו.
      </div>
